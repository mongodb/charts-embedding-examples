...
namespace ChartsEmbedding.Controllers
{
    ...
    public class EmbeddedChartController : ControllerBase
    {
        ...
        private const string CHARTS_EMBEDDING_BASE_URL = "~REPLACE~CHARTS_EMBEDDING_BASE_URL"; // Replace with the base URL to your Charts instance, e.g. https://charts.mongodb.com/charts-foo-abcde
        private const string CHARTS_TENANT_ID = "~REPLACE~CHARTS_TENANT_ID"; // Replace with your Charts Tenant ID from the Embed Chart snippet 
        ...
        public ActionResult<string> Get(string id)
        {
            ...
            string payload = $"id={id}&tenant={CHARTS_TENANT_ID}&timestamp={timestamp}&expires-in={expiryTime.TotalSeconds}";
